...
import com.wang.adapter.FragmentAdapter;
import com.rental.R;

public class HobbyMainFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
	    	...
	    	View rootView = inflater.inflate(R.layout.fragment_im, null);
	    	/**
		* 初始化三个Fragment  并且填充到ViewPager
		*/
		vPager = (ViewPager) rootView.findViewById(R.id.viewpager_home);
		MainFragment imMessageFragment=new MainFragment();
		NewsFragment imFriendFragment=new NewsFragment();
//		PatientQueryFragment imFriendFragment=new PatientQueryFragment();
