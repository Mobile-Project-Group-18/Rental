...
public class DialogBottonListMsg {
	...
	public DialogBottonListMsg(Context context) {
		super();
		this.context = context;

		loadingView = LayoutInflater.from(context).inflate(R.layout.dialog_bottom_list_show, null);
		InitData();
	}
